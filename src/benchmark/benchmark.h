...
void test_parallel_loop_permutations(double time_results[], Matrix a, Matrix b, int thread_count,
                                    int chunk);
void test_serial_parallel_scaling_classic(double time_results[], Matrix a, Matrix b, int chunk_size);
void test_serial_parallel_scaling_improved(double time_results[], Matrix a, Matrix b, int chunk_size);
