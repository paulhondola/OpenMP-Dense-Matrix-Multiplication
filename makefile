...
loop:
	...
	./$(LOOP_TARGET) 1000 10 1
	./$(LOOP_TARGET) 1000 10 10
	./$(LOOP_TARGET) 1000 10 100
	./$(LOOP_TARGET) 2000 10 1
	./$(LOOP_TARGET) 2000 10 10
	./$(LOOP_TARGET) 2000 10 100
	./$(LOOP_TARGET) 3000 10 1
	./$(LOOP_TARGET) 3000 10 10
	./$(LOOP_TARGET) 3000 10 100
